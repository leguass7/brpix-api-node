...
import { IResponseAccessToken, IResponseCob, UseQRCodeParams } from './types/responses-types';
...
declare class ApiPix {
     ...
     */
    createQRCodePayload(cob: IResponseCob, adicionalData?: Omit<UseQRCodeParams, 'width'>): QRCodePayload;
    /**
